component {
	...
	public void function configure( binder ) {
		...
		s3StorageSettings.region    = s3StorageSettings.region    ?: "us-east-1"
		s3StorageSettings.subpath   = s3StorageSettings.subpath   ?: ""
		s3StorageSettings.rootUrl   = s3StorageSettings.rootUrl   ?: "https://s3.#s3StorageSettings.region#.amazonaws.com";
